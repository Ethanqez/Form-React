...
const handleChange = (e) => {
  ...
  return (
    <div>
      ...
      <input class="boton" type='button' value="Mostrar Marcaciones"
        style={{height: "50px", textAlign: 'center', fontSize: "14px",alignContent: "center",
          margin: "17px", width: "150px", display : "flex", alignItems: "center"}}/>
